...
<body>
<form  class="rt_wrap content mCustomScrollbar"  action="/goods/addGoods" method="post" enctype="multipart/form-data">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加商品</h2>
            <a  href="../manager/goods_list.jsp" class="fr top_rt_btn">返回商品列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <li>
                    <span class="item_name" style="width:120px;">商品名称：</span>
                    <input name="goodName" type="text" class="textbox" placeholder="商品名称..."/>
                </li>
                <li>
                ...
                <li>
                    ...
                    <input name="goodPrice" type="text" class="textbox" placeholder="商品价格..."/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">商品库存：</span>
                    <input name="goodNum" type="text" class="textbox" placeholder="商品库存..."/>
                </li>
                <li>
                ...
                <li >
                    ...
                    <input name="goodShopId" type="text" class="textbox textbox_295" placeholder="卖家编号..."/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">商品介绍：</span>
                    <textarea name="goodIntroduce" cols="20" rows="5">商品介绍</textarea>
                </li>
                <li>
